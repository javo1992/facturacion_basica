...
<div class="page-wrapper">
      <div class="page-content">
          ...
          <div class="breadcrumb-title pe-3">Datos de empresa</div>
          <div class="ps-3">
		...
		<div class="card">
			<div class="card-body">
		        ...
		        <div class="row">
					...
					<div class="col-sm-3">
						<button type="button" class="btn btn-sm btn-primary" onclick="guardar_datos()">Guardar datos de empresa</button>
					</div>
				</div>
					  ...
					  <div class="tab-pane container active" id="home">
						  	...
						  	<div class="row">
					                 ...
					                 <div class="">
					               		...
					               		<button class="btn btn-sm btn-primary btn-block" id="subir_imagen" type="button">Cargar imagen</button>
					           		</form>   
					       	   	</div>
					       </div>
					 	 </div> 
					  ...
					  <div class="tab-pane container fade" id="menu1">
					  	...
					  	<div class=" card card-body">
					  		...
					  		<div class="row">
						  		...
						  		<div class="col-sm-2">
						  			<button class="btn btn-sm btn-primary" type="button" id="btn_certificados">Subir archivo</button>
						  		</div>
					  		</div>
						  	  </form>
					  	</div>	
