...
<head>
    ...
    <!-- js externos-->
    <script src="../js/ext/jquery-3.5.1.min.js"></script>  <!-- funciona selec2 bien -->
    <script src="../js/ext/sweetalert2.js"></script>    
    <script src="../js/ext/inicio.js"></script>     
    <script src="../js/ext/funciones_globales.js"></script>    
    <script src="../js/ext/select2.min.js"></script>       
    <script src="../js/ext/jquery-ui.js"></script>   
    <script src="../js/ext/informes.js"></script>  
