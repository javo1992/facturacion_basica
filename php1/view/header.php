...
if(!isset($_SESSION['INICIO']['TOKEN'])){header('Location: login.php');}?> 
<!doctype html>
<html lang="en">
	  ...
	  <input type="hidden" name="" id="eliminar">
		...
		<div class="sidebar-wrapper" data-simplebar="true">
			<div class="sidebar-header">
				<div>
					<img src="../img/sistema/logo_azul.png" class="logo-icon" alt="logo icon">
				</div>
				<div>
			...
			<!--navigation-->
			<ul class="metismenu"  id="accordionSidebar">
				...
				<nav class="navbar navbar-expand">
					...
					<div class="user-box dropdown">
						<a class="d-flex align-items-center nav-link dropdown-toggle dropdown-toggle-nocaret" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
							<img src="<?php if( isset($_SESSION['INICIO']['FOTO'])){echo $_SESSION['INICIO']['FOTO']; }else{echo '../img/sistema/user.jpg';} ?>" class="user-img" alt="user avatar">
						...
						<ul class="dropdown-menu dropdown-menu-end">
							...
							<li><a class="dropdown-item" href="inicio.php?mod=&acc=descargas"><i class='bx bx-download'></i><span>Descargas</span></a>
							</li>
							<li>
								<div class="dropdown-divider mb-0"></div>
							</li>
							<li><a class="dropdown-item" href="javascript:;" onclick="eliminar_session()"><i class='bx bx-log-out-circle'></i><span>Salir de sistema</span></a>
