...
<div class="page-wrapper">
      <div class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
          <div class="breadcrumb-title pe-3">Guia de remision</div>
          <div class="ps-3">
      ...
      <div class="row">
    	<div class="col-sm-10">    		
    		<a class="btn btn-default btn-sm" style="border: 1px solid;" href="lista_guia.php"><i class="bx bx-arrow-back"></i> Regresar</a>
            <button class="btn btn-default btn-sm" style="border: 1px solid;" onclick="pdf_guia()"><i class="bx bx-printer"></i> Imprimir</button>
            <button class="btn btn-info btn-sm" style="border: 1px solid;" onclick="modal_email()"><i class="bx bx-envelope"></i> Enviar</button>
            <button class="btn btn-warning btn-sm" style="border: 1px solid;" id="btn_autorizar" onclick="$('#modal_auto').modal('show');$('#fecha_fac').select()"><i class="bx bx-paper-plane"></i> Autorizar</button>
            <button class="btn btn-danger btn-sm" style="border: 1px solid;display: none;" id="btn_sri_error" onclick="modal_error_seri($('#LblAutGuiaRem').text(),'GUIA_REMISION')"><i class="bx bx-eye"></i> Ver error en xml guia</button>    
             <button class="btn btn-danger btn-sm" style="border: 1px solid;display: none;" id="btn_sri_error_fac" onclick="modal_error_seri($('#lbl_autorizacion_fac').text(),'FACTURAS')"><i class="bx bx-eye"></i> Ver error en xml guia</button>      
    	</div>
    ...
    <form id="form_guia">
		...
		<div class="row" id="pane_factura">
			...
			<div class="col-sm-2 text-end">
				<br>
				<button type="button" class="btn btn-primary btn-sm" id="btn_ver_factura" style="display:none;" onclick="ver_factura()"><i class="bx bx-eye"></i>Ver factura</button>
			</div>
		</div>
		<hr>
		<div class="row">
